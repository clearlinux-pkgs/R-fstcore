...
Version  : 0.10.0
Release  : 19
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/fstcore_0.10.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/fstcore_0.10.0.tar.gz
...
%package dev
Summary: dev components for the R-fstcore package.
Group: Development
Requires: R-fstcore-lib = %{version}-%{release}
Provides: R-fstcore-devel = %{version}-%{release}
Requires: R-fstcore = %{version}-%{release}

%description dev
dev components for the R-fstcore package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739287232
...
cp %{_builddir}/fstcore/src/fstlib/LZ4/LICENSE %{buildroot}/usr/share/package-licenses/R-fstcore/63aa9e87fdd44f2c9627db9a6b6d29a95e6ef53d || :
...
/usr/lib64/R/library/fstcore/tests/testthat/data/1.fst
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/fstcore/libs/fstcore.so
/V4/usr/lib64/R/library/fstcore/libs/fstcore.so
/usr/lib64/R/library/fstcore/libs/fstcore.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/R-fstcore/63aa9e87fdd44f2c9627db9a6b6d29a95e6ef53d

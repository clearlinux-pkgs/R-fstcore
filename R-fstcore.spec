...
Version  : 0.9.8
Release  : 1
URL      : https://cran.r-project.org/src/contrib/fstcore_0.9.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fstcore_0.9.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644341239
